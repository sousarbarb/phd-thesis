...
\mathbf{X} = \arg \min_\mathbf{X} \sum_i
...
As for probabilistic-based approaches, these methods typically require
computing a map estimate of the environment over time, which is not compatible
with scan-to-scan registration. In contrast, distance maps

...
Moreover, \gls{gicp}~\cite{segal:rss:2009} retains the standard \gls{icp}
...
\gls{ndt}~\cite{biber-strasser:iros:2003,magnusson:jfr:2007}
registration algorithms on the evaluated datasets.

Probabilistic-based registration?
\gls{ndt}~\cite{biber-strasser:iros:2003,magnusson:jfr:2007},
GMapping~\cite{grisetti:tro:2007},
Cartographer~\cite{hess:icra:2016}.
...
\section{Least-squares optimization}\label{sec:distance-maps:background:least-squares}

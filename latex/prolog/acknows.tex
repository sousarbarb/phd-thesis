...
Simultaneous Localisation and Mapping~(SLAM), calibration, control systems, and
...
special thanks to Prof.~António~Paulo (once again, appears quite frequently in
these acknowledgements), Cláudia~Rocha, João~Martins, José~Pedro, José~Sarmento,
